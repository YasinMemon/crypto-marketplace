...
<body class="bg-gradient-to-br from-gray-900 via-purple-900 to-black text-white min-h-screen flex flex-col">
    ...
    <!-- Navbar -->
    <nav class="flex justify-between items-center px-8 py-4 bg-opacity-30 backdrop-blur-lg border-b border-gray-700 fixed w-full top-0 z-50">
        <div class="text-3xl font-extrabold tracking-wide text-indigo-400">Cryptoplace</div>
        <ul class="flex gap-8 items-center text-lg">
            <li class="hover:text-indigo-300 cursor-pointer transition-all duration-300">Home</li>
            <li class="hover:text-indigo-300 cursor-pointer transition-all duration-300">Futures</li>
            <li class="hover:text-indigo-300 cursor-pointer transition-all duration-300">Blog</li>
            <li>
                <button class="bg-indigo-500 hover:bg-indigo-400 transition-all duration-300 text-white px-6 py-2 rounded-lg font-semibold shadow-lg">
                    Sign Up
                </button>
            </li>
        </ul>
